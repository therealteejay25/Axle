        ...
        <section>
          ...
          <Card className="p-8 bg-white/5 border border-white/5 rounded-2xl space-y-6">
            <div className="grid grid-cols-2 gap-6">
              <Input label="Display Name" defaultValue="Ariyo Eyitayo" className="bg-black/20 border-white/10" />
              <Input label="Email Address" defaultValue="ariyo@axle.ai" disabled className="bg-black/10 border-white/5 text-white/40" />
            </div>
            <div className="flex justify-end pt-4">
              <Button className="bg-white text-black hover:bg-white/90 rounded-full px-8">Update Profile</Button>
            </div>
          </Card>
        </section>
